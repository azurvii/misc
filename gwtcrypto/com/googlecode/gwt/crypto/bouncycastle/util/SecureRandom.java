...
import com.googlecode.gwt.crypto.bouncycastle.crypto.digests.SHA1Digest;
import com.googlecode.gwt.crypto.bouncycastle.crypto.digests.SHA256Digest;
import com.googlecode.gwt.crypto.bouncycastle.crypto.prng.DigestRandomGenerator;
import com.googlecode.gwt.crypto.bouncycastle.crypto.prng.RandomGenerator;

/**
 * An implementation of SecureRandom specifically for the light-weight API, JDK 1.0, and the J2ME.
 * Random generation is based on the traditional SHA1 with counter. Calling setSeed will always
 * increase the entropy of the hash.
 * <p>
 * <b>Do not use this class without calling setSeed at least once</b>! There are some example seed
 * generators in the org.bouncycastle.prng package.
 */
...
public class SecureRandom extends Random {
  ...
  private static final RandomGenerator sha256Generator =
